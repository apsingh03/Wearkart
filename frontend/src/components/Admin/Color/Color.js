...
import {
  ...
  getColorAsync,
  updateColorAsync,
} from "../../../Redux/AdminSlices/Color/ColorSlice.js";

const Color = () => {
  const admin_colorRedux = useSelector((state) => state.admin_color.data);

  // console.log("admin_colorRedux - ", admin_colorRedux.query);
  ...
  async function fetchData() {
    ...
    const actionResult = await dispatch(getColorAsync());
  ...
  async function deleteHandler(event, id) {
    ...
    if (window.confirm("Are you sure want to Delete It ?")) {
      const actionResult = await dispatch(deleteColorAsync({ id }));
                ...
                <form onSubmit={handleSubmit}>
                  <div className="form-group mb-3">
                    <div className="d-flex align-items-baseline">
                      <label htmlFor="sizeName">Color Name</label>
            ...
            <table className="table">
              ...
              <tbody>
                {(function () {
                  try {
                    return (
                      admin_colorRedux.query &&
                      admin_colorRedux.query.map((data, index) => {
                        return (
                          <tr key={index}>
