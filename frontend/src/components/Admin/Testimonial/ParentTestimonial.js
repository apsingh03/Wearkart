...
import {
  createParentTestimonialAsync,
  deleteParentTestimonialAsync,
  getParentTestimonialAsync,
  testimonialIsFavoriteAsync,
  updateParentTestimonialAsync,
} from "../../../Redux/AdminSlices/Testimonial/parentTestimonialSlice";
...
const ParentTestimonial = () => {
  ...
  async function deleteHandler(event, id) {
    ...
    if (window.confirm("Are you sure want to Delete It ?")) {
      const actionResult = await dispatch(deleteParentTestimonialAsync({ id }));
              ...
              <tbody>
                {(function () {
                  try {
                    return (
                      admin_parentTestimonialRedux.query &&
                      admin_parentTestimonialRedux.query.map((data, index) => {
                        return (
                          <tr key={index}>
