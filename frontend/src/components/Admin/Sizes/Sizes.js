...
} from "../../../Redux/AdminSlices/Sizes/SizesSlice.js";
...
const Sizes = () => {
  ...
  // console.log("admin_productSizeRedux - ", admin_productSizeRedux.query);
  ...
  async function fetchData() {
    ...
    const actionResult = await dispatch(getProductSizeAsync());
  ...
  async function deleteHandler(event, id) {
    ...
    if (window.confirm("Are you sure want to Delete It ?")) {
      const actionResult = await dispatch(deleteProductSizeAsync({ id }));
                ...
                {(function () {
                  try {
                    return (
                      ...
                      admin_productSizeRedux.query.map((data, index) => {
                        return (
                          <tr key={index}>
