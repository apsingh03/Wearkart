...
import {
  actressCarouselIsFavoriteAsync,
  createParentActressCarouselAsync,
  deleteParentActressCarouselAsync,
  getParentActressCarouselAsync,
  updateParentActressCarouselAsync,
} from "../../../Redux/AdminSlices/ActressCarousel/parentActressCarouselSlice";

const ParentActressCarousel = () => {
  ...
  async function deleteHandler(event, id) {
    ...
    if (window.confirm("Are you sure want to Delete It ?")) {
      const actionResult = await dispatch(
        deleteParentActressCarouselAsync({ id })
      );
                    ...
                    <div className="col-6">
                      <div className="form-group mb-3">
                        <div className="d-flex align-items-baseline">
                          <label htmlFor="groupName">Actress Group Name</label>
...
export default ParentActressCarousel;
